...
<svelte:head>
	...
	<meta
		name="description"
		content="View the professional experience of Joseph Talon as well as key personal projects he has worked on."
	/>
</svelte:head>
...
<main>
	...
	<section id="projects">
		...
		{#each data.projects as proj}
			<div
				on:click={() => goto(`/work/${proj.frontmatter.name}`)}
				key={proj.frontmatter.name}
